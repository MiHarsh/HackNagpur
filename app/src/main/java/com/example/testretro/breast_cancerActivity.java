...
public class breast_cancerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        symptoms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("https://www.mayoclinic.org/diseases-conditions/breast-cancer/symptoms-causes/syc-20352470"));
        ...
        up.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(breast_cancerActivity.this, "Upload is in progress", Toast.LENGTH_SHORT).show();
                }
                else {
                    Fileuploader();
                }
    ...
    private void sendNetworkRequest(url_model m_url_model)
    {
        Retrofit.Builder builder=new Retrofit.Builder()
                .baseUrl("https://medivision-hack.herokuapp.com/breastcancer/")
        ...
        call.enqueue(new Callback<url_model>() {
            ...
            public void onResponse(Call<url_model> call, Response<url_model> response) {
                if(response.body()!=null)
                {
                    ...
                    result1.setText("Benign: "+response.body().getBenign());
                    result2.setText("Malignant: "+response.body().getMalignant());
                    result3.setText("Normal: "+response.body().getNormalBreastCancer());
                    ...
                    Toast.makeText(breast_cancerActivity.this, "Not Working", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<url_model> call, Throwable t) {
                ...
                // Toast.makeText(breast_cancerActivity.this, "something went wrong", Toast.LENGTH_SHORT).show();
            }
        });
    }
