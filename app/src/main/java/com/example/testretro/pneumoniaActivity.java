...
public class pneumoniaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        symptoms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("https://www.mayoclinic.org/diseases-conditions/pneumonia/symptoms-causes/syc-20354204"));
        ...
        up.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(pneumoniaActivity.this, "Upload is in progress", Toast.LENGTH_SHORT).show();
                }
                else {
                    Fileuploader();
                }
    ...
    private void sendNetworkRequest(url_model m_url_model)
    {
        Retrofit.Builder builder=new Retrofit.Builder()
                .baseUrl("https://medivision-hack.herokuapp.com/pneumonia/")
        ...
        call.enqueue(new Callback<url_model>() {
            ...
            public void onResponse(Call<url_model> call, Response<url_model> response) {
                if(response.body()!=null)
                {
                    ...
                    result1.setText("Normal: "+response.body().getNormal());
                    result2.setText("Pneumonia: "+response.body().getPneumonia());
                    ...
                    Toast.makeText(pneumoniaActivity.this, "Not Working", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<url_model> call, Throwable t) {
                ...
                // Toast.makeText(pneumoniaActivity.this, "something went wrong", Toast.LENGTH_SHORT).show();
            }
        });
    }
