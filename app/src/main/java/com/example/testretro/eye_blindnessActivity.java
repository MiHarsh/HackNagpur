...
public class eye_blindnessActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        symptoms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("https://www.mayoclinic.org/diseases-conditions/retinal-diseases/symptoms-causes/syc-20355825"));
    ...
    private void sendNetworkRequest(url_model m_url_model)
    {
        Retrofit.Builder builder=new Retrofit.Builder()
                .baseUrl("https://medivision-hack.herokuapp.com/aptos/")
        ...
        call.enqueue(new Callback<url_model>() {
            ...
            public void onResponse(Call<url_model> call, Response<url_model> response) {
                if(response.body()!=null)
                {
                    ...
                    result1.setText("Mild Diabetic Retinopathy: "+response.body().getMild_Diabetic_Retinopathy());
                    result2.setText("Moderate Diabetic Retinopathy: "+response.body().getModerate_Diabetic_Retinopathy());
                    result3.setText("No Diabetic Retinopathy: "+response.body().getNo_Diabetic_Retinopathy());
                    result4.setText("Proliferative Diabetic Retinopathy: "+response.body().getProliferative_Diabetic_Retinopathy());
                    result5.setText("Severe Diabetic Retinopathy: "+response.body().getSevere_Diabetic_Retinopathy());
